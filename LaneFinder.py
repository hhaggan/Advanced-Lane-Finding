...
class LaneFinder:
    def __init__(self,
        ...
        self._chessboard_image_path_list = [os.path.join(self._chessboard_image_dir, fname) for fname in os.listdir(self._chessboard_image_dir)]
    ...
    def pipeline(self, image):
        ...
        fit_polynomial_vis = self.fit_polynomial(image=warped)
